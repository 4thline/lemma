...
public class XMLContentPrinter extends CalloutContentPrinter {
    ...
    final public static Pattern PATTERN_COMMENT_BEGIN = Pattern.compile(".*?\\<\\!\\-\\-.*");
    final public static Pattern PATTERN_COMMENT_END = Pattern.compile(".*?-->.*");
    ...
    protected Pattern getCommentBeginPattern() {
        return PATTERN_COMMENT_BEGIN;
    }

    @Override
    protected Pattern getCommentEndPattern() {
        return PATTERN_COMMENT_END;
    }
